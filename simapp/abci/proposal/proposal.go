...
type (
	// ProposalTxVerifier defines the interface that is implemented by App,
...
func NewDefaultProposalHandler(logger log.Logger, mp mempool.Mempool, txVerifier ProposalTxVerifier) *DefaultProposalHandler {
